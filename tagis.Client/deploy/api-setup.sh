...
sudo npm install npm@5.3.0 -g -y;
...
mkdir /var/www/tagis/;
mkdir /var/www/html/;
sudo git clone git@github.com:loganfarr/tagis.git /var/www/tagis/;
mv /var/www/tagis/api/* /var/www/html/.;
cp /var/www/tagis/package.json /var/www/html/.;
